...
@section('meta_description', 'Contactez KardAfrica : WhatsApp +241 77 04 78 61, email hello@kardafrica.com. Support 7 jours sur 7 pour vos achats de cartes cadeaux au Gabon.')
    ...
    <section style="position: relative; margin-top: -80px; padding: 0 16px 80px;">
        <div style="max-width: 1200px; margin: 0 auto;
            ...
            @foreach ([
                ...
                ['title' => 'Téléphone', 'value' => '+241 77 04 78 61',     'desc' => '7 jours / 7, 8h — 22h',           'href' => 'tel:+24177047861',           'color' => '#3B82F6', 'icon' => 'M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z'],
                ['title' => 'WhatsApp',  'value' => 'Chat instantané',      'desc' => "Le canal le plus rapide",          'href' => 'https://wa.me/24177047861',  'color' => '#25D366', 'icon' => 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z'],
