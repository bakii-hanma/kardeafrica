{{-- ================================================================
     Réassurance + Paiement (regroupés) — placé sous la section Carte Gabon.
     3 garanties + moyens de paiement (logos couleur d'origine, statiques).
     ================================================================ --}}
<section class="mb-16">
    <div class="rounded-2xl border border-slate-100 bg-white shadow-card p-5 sm:p-6">
        ...
        <div class="grid sm:grid-cols-3 gap-4 sm:gap-6">
            @foreach([
                ...
                ['M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z', 'Paiement sécurisé', 'Airtel Money, Moov Money & carte bancaire via E-Billing, opérateur de paiement gabonais agréé.'],
        ...
        {{-- Moyens de paiement : logos couleur, statiques --}}
        <div class="mt-5 pt-5 border-t border-slate-100 flex flex-wrap items-center justify-center gap-x-6 gap-y-3">
            <span class="text-[10px] uppercase tracking-[0.15em] text-slate-400 font-bold">Paiement</span>
            @include('partials._payment-logos')
        </div>
    </div>
</section>
