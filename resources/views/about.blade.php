        ...
        <div style="position: relative; max-width: 1200px; margin: 0 auto; text-align: center;">
            ...
            <div style="display: flex; flex-wrap: wrap; align-items: center; justify-content: center;
                    ...
                    <div style="display: flex;">
                        @foreach (['#44A08D', '#7C3AED', '#EA580C', '#3B82F6'] as $i => $c)
                            <div style="width: 28px; height: 28px; border-radius: 50%;
                                        background: {{ $c }}; border: 2px solid #0F172A;
                                        margin-left: {{ $i === 0 ? '0' : '-8px' }};"></div>
                        @endforeach
                    </div>
                ...
                <div style="display: flex; align-items: center; gap: 6px;">
                    ...
                    @endfor
                    <span style="margin-left: 6px; font-size: 12px; font-weight: 600; color: #CBD5E1;">4.9/5 — 1 200+ avis</span>
                </div>
            </div>
        </div>
